...
exports.addUserProject=async(req,res)=>{
    ...
    try{
        ...
        if(existingProject){
            ...
            //if github is not present in mongodb then create new project and save them in mongodb

            const newProject=new projects({
                title,language,github,link,overview,projectImage,userId
            })
            await newProject.save()//save new project into mongodb
...
exports.getAllUserProjects=async(req,res)=>{
    ...
    try{
        ...
        res.status(200).json(userProject)//snd all projects to frontend
    }
    catch(err){
